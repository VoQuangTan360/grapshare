...
class dialogmess : DialogFragment() {
...
//    var data = MutableLiveData<Post>()
    var dataPost = MutableLiveData<Post>(Post("1","2","tanvo360","Su Pham Ky Thuat","1","car",
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnYes.setOnClickListener{
            model.setStatusPickDialog("111")
            model.setStatusfinish("ok")

            dismiss()
//           if(dataPost.value!=null) {
//                Log.d(TAG,"post 1 ${dataPost.value}")
//                lifecycleScope.launchWhenStarted {
//                    locationViewModel.addPost(dataPost.value as Post).collect{
//                        when (it) {
//                            is State.Loading -> {
//                                if (it.flag == true) {
